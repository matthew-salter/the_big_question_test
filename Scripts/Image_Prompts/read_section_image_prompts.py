...
def run_prompt(data):
    try:
        ...
        supabase_path = f"Predictive_Report/Ai_Responses/Section_Image_Prompts/{run_id}.txt"
        ...
        while retries < MAX_RETRIES:
            try:
                ...
                return {
                    "status": "success",
                    "run_id": run_id,
                    "section_image_prompts": flattened
                }
        ...
        return {
            "status": "error",
            "run_id": run_id,
            "message": "Section Image Prompts file not yet available. Try again later."
        }

    except Exception as e:
        logger.exception("Unhandled error in read_section_image_prompts")
        return {
            "status": "error",
