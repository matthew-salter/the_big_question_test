...
def run_prompt(data):
    try:
        ...
        supabase_path = f"Predictive_Report/Ai_Responses/Prompt_4_Tables/{run_id}.txt"
        ...
        return {
            "status": "error",
            "run_id": run_id,
            "message": "Prompt 4 Tables file not yet available. Try again later."
        }

    except Exception as e:
        logger.exception("Unhandled error in read_prompt_4_tables")
        return {
            "status": "error",
