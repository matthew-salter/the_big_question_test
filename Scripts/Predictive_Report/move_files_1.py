...
def run_prompt(data: dict) -> dict:
    ...
    move_folder_contents("The_Big_Question/Predictive_Report/Ai_Responses/Report_and_Section_Tables", target_map.get("Report_Tables", target_map.get("Report_and_Section_Tables", "")), skipped_files)
